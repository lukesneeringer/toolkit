...
public class PythonModelTypeNameConverter implements ModelTypeNameConverter {
  ...
  private static final ImmutableMap<Type, String> PRIMITIVE_ZERO_VALUE =
      ImmutableMap.<Type, String>builder()
          ...
          .put(Type.TYPE_STRING, "\'\'") // will be a bytestring on Python 2
  ...
  private static final ImmutableMap<Type, String> PRIMITIVE_TYPE_MAP =
      ImmutableMap.<Type, String>builder()
          ...
          .put(Type.TYPE_STRING, "str") // will be a bytestring on Python 2
  ...
  public PythonModelTypeNameConverter(String implicitPackageName) {
    this.typeNameConverter = new PythonTypeTable(implicitPackageName);
  }
  ...
  /**
   * Returns the Python representation of a type. If the type is a primitive,
  ...
  public TypeName getTypeName(ProtoElement elem) {
    return typeNameConverter.getTypeName(NamePath.dotted(elem.getFullName()).toDotted());
  }

  /**
   * Returns the Python representation of an empty / falsy value for that type, to be used in code
   * sample doc.
   */
  @Override
  ...
  public TypedValue getEnumValue(TypeRef type, String value) {
    throw new UnsupportedOperationException("getEnumValue not supported by Python");
  }
}
